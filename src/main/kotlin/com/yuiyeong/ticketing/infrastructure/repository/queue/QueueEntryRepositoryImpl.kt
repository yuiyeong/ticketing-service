package com.yuiyeong.ticketing.infrastructure.repository.queue
...
import com.yuiyeong.ticketing.infrastructure.entity.queue.QueueEntryEntity
import com.yuiyeong.ticketing.infrastructure.entity.queue.QueueEntryEntityStatus
...
class QueueEntryRepositoryImpl(
    ...
    override fun findLastWaitingPosition(): Long? =
        queueEntryJpaRepository.findLastPositionByStatus(
            QueueEntryEntityStatus.READY,
        )

    override fun findFirstWaitingPosition(): Long? =
